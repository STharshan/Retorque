...
const services = [
  {
    ...
    desc: `Removes carbon buildup from engine components to restore efficiency.`,
    image: "/carpaint.avif",
    path: "/services/mechanical",
  },
  {
    title: "Performance Tuning",
    desc: `Optimizes engine settings to increase power, responsiveness, and overall driving performance.
​`,
    image: "/gray.avif",
  ...
  {
    title: "dpf cleaning",
    desc: `Professional DPF cleaning to keep your car compliant.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-25 mx-auto h-35 object-cover"
                    onError={(e) => {
